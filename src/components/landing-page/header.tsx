          ...
          <NavigationMenuItem>
            <NavigationMenuTrigger
              ...
              className={cn({
                ...
                'dark:text-gray-400': path !== '#resources',
                'font-normal': true,
                'text-xl': true,
              })}
            >
            ...
            <NavigationMenuContent>
              <ul className='grid gap-3 p-6 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]'>
                ...
                <ListItem href='#' title='Introduction'>
                  Re-usable Components build using Radix UI and Tailwind Css.
                </ListItem>
                <ListItem href='#' title='Installation'>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
                </ListItem>
                <ListItem href='#' title='Typography'>
                  Doloremque atque saepe aliquid numquam iure porro, inventore vel expedita non odio
                  ex,
                </ListItem>
              </ul>
            </NavigationMenuContent>
          ...
          <NavigationMenuItem>
            <NavigationMenuTrigger
              ...
              className={cn({
                ...
                'dark:text-gray-400': path !== '#pricing',
                'font-normal': true,
                'text-xl': true,
              })}
            >
            ...
            <NavigationMenuContent>
              <ul className='grid w-[400px] gap-3 p-4 md:grid-rows-2'>
                <ListItem title='Pro Plan' href='#'>
                  Unlock full power with collaboration and publishing features
                </ListItem>
